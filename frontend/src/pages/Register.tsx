...
import { phoneRegistration } from "../services/PhoneRegistrationService";
...
try {
const response = await phoneRegistration(payload);
...
console.warn('user_id not found in response:', response.data);
}
